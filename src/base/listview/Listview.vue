<template>
  <scroll :data="data" @scroll="onScroll"
    ...
    <div class="list-shortcut"
      ...
      <ul>
        <li v-for="(item, index) in shortcutList"
            :key="index" class="item" :data-index="index"
...
export default {
  ...
  methods: {
    ...
    onShortcutTouchMove(e) {
      ...
      let moveIndexs = (this.touch.y2 - this.touch.y1) / ANCHOR_HEIGHT | 0
      let anchorIndex = parseInt(this.touch.anchorIndex) + moveIndexs
      this._scrollTo(anchorIndex)
    },
    onScroll(pos) {
      this.scrollY = pos.y
